...
!function(factory) {
    ...
    for (var class2type = {}, classTypes = 'Boolean Number String Function Array Date RegExp Object Error'.split(' '), nameNdx = 0; nameNdx < classTypes.length; nameNdx++) {
    ...
    return DependencyLib.prototype = {
                ...
                for (var eventRegistry = this[0].eventRegistry, elem = this[0], _events = 'string' == typeof events ? events.split(' ') : [ events.type ], endx = 0; endx < _events.length; endx++) {
                    ...
                    if (void 0 !== document && 'global' === namespace) {
                        ...
                        if (document.createEvent) {
                            ...
                            evnt = document.createEventObject(), evnt.eventType = ev, events.type && DependencyLib.extend(evnt, events), 
        ...
        if (isArray) {
            for (;i < length; i++) {
                value = callback(elems[i], i), null != value && ret.push(value);
            }
        } else {
            for (i in elems) {
