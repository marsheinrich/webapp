...
(function(e){
    ...
    function t(t,s){
        var n,a,o,r=t.nodeName.toLowerCase();return'area'===r?(n=t.parentNode,a=n.name,t.href&&a&&'map'===n.nodeName.toLowerCase()?(o=e('img[usemap=\'#'+a+'\']')[0],!!o&&i(o)):!1):(/^(input|select|textarea|button|object)$/.test(r)?!t.disabled:'a'===r?t.href||s:s)&&i(t);
    }function i(t){
        ...
        var s=e.attr(i,'tabindex'),n=isNaN(s);return(n||s>=0)&&t(i,!n);
    }}),e('<a>').outerWidth(1).jquery||e.each(['Width','Height'],function(t,i){
        function s(t,i,s,a){
            return e.each(n,function(){
                i-=parseFloat(e.css(t,'padding'+this))||0,s&&(i-=parseFloat(e.css(t,'border'+this+'Width'))||0),a&&(i-=parseFloat(e.css(t,'margin'+this))||0);
            }),i;
        }var n='Width'===i?['Left','Right']:['Top','Bottom'],a=i.toLowerCase(),o={innerWidth:e.fn.innerWidth,innerHeight:e.fn.innerHeight,outerWidth:e.fn.outerWidth,outerHeight:e.fn.outerHeight};e.fn['inner'+i]=function(t){
        ...
        var n,a=e.ui[t].prototype;for(n in s){
            a.plugins[n]=a.plugins[n]||[],a.plugins[n].push([i,s[n]]);
        }
    },call:function(e,t,i,s){
        var n,a=e.plugins[t];if(a&&(s||e.element[0].parentNode&&11!==e.element[0].parentNode.nodeType)){
            for(n=0;a.length>n;n++){
                e.options[a[n][0]]&&a[n][1].apply(e.element,i);
            }
        }
    }};var l=0,u=Array.prototype.slice;e.cleanData=function(t){
        return function(i){
        ...
        var n,a,o,r,h={},l=t.split('.')[0];return t=t.split('.')[1],n=l+'-'+t,s||(s=i,i=e.Widget),e.expr[':'][n.toLowerCase()]=function(t){
            return!!e.data(t,n);
            ...
            return e.isFunction(s)?(h[t]=function(){
                var e=function(){
                    ...
                    var t,i=this._super,a=this._superApply;return this._super=e,this._superApply=n,t=s.apply(this,arguments),this._super=i,this._superApply=a,t;
                };
            }(),void 0):(h[t]=s,void 0);
        ...
        var s=i.prototype.widgetFullName||t;e.fn[t]=function(n){
            var a='string'==typeof n,o=u.call(arguments,1),r=this;return a?this.each(function(){
                var i,a=e.data(this,s);return'instance'===n?(r=a,!1):a?e.isFunction(a[n])&&'_'!==n.charAt(0)?(i=a[n].apply(a,o),i!==a&&void 0!==i?(r=i&&i.jquery?r.pushStack(i.get()):i,!1):void 0):e.error('no such method \''+n+'\' for '+t+' widget instance'):e.error('cannot call methods on '+t+' prior to initialization; '+'attempted to call method \''+n+'\'');
        ...
        var s,n,a,o=t;if(0===arguments.length){
        ...
        var n,a=this;'boolean'!=typeof t&&(s=i,i=t,t=!1),s?(i=n=e(i),this.bindings=this.bindings.add(i)):(s=i,i=this.element,n=this.widget()),e.each(s,function(s,o){
            ...
            }'string'!=typeof o&&(r.guid=o.guid=o.guid||r.guid||e.guid++);var h=s.match(/^([\w:-]*)\s*(.*)$/),l=h[1]+a.eventNamespace,u=h[2];u?n.delegate(u,l,r):i.bind(l,r);
        });
    },_off:function(t,i){
        ...
        var n,a,o=this.options[t];if(s=s||{},i=e.Event(i),i.type=(t===this.widgetEventPrefix?t:this.widgetEventPrefix+t).toLowerCase(),i.target=this.element[0],a=i.originalEvent){
            for(n in a){
                n in i||(i[n]=a[n]);
            }
        ...
        e.Widget.prototype['_'+t]=function(s,n,a){
            'string'==typeof n&&(n={effect:n});var o,r=n?n===!0||'number'==typeof n?i:n.effect||i:t;n=n||{},'number'==typeof n&&(n={duration:n}),o=!e.isEmptyObject(n),n.complete=a,n.delay&&s.delay(n.delay),o&&e.effects&&e.effects.effect[r]?s[t](n):r!==t&&s[r]?s[r](n.duration,n.easing,a):s.queue(function(i){
        ...
        if(!d){
            this._mouseMoved=!1,this._mouseStarted&&this._mouseUp(t),this._mouseDownEvent=t;var i=this,s=1===t.which,n='string'==typeof this.options.cancel&&t.target.nodeName?e(t.target).closest(this.options.cancel).length:!1;return s&&!n&&this._mouseCapture(t)?(this.mouseDelayMet=!this.options.delay,this.mouseDelayMet||(this._mouseDelayTimer=setTimeout(function(){
                i.mouseDelayMet=!0;
        ...
        function t(e,t,i){
        ...
        }e.ui=e.ui||{};var n,a,o=Math.max,r=Math.abs,h=Math.round,l=/left|center|right/,u=/top|center|bottom/,d=/[\+\-]\d+(\.[\d]+)?%?/,c=/^\w+/,p=/%$/,f=e.fn.position;e.position={scrollbarWidth:function(){
            if(void 0!==n){
                return n;
            }var t,i,s=e('<div style=\'display:block;position:absolute;width:50px;height:50px;overflow:hidden;\'><div style=\'height:100px;width:auto;\'></div></div>'),a=s.children()[0];return e('body').append(s),t=a.offsetWidth,s.css('overflow','scroll'),i=a.offsetWidth,t===i&&(i=s[0].clientWidth),s.remove(),n=t-i;
        },getScrollInfo:function(t){
            var i=t.isWindow||t.isDocument?'':t.element.css('overflow-x'),s=t.isWindow||t.isDocument?'':t.element.css('overflow-y'),n='scroll'===i||'auto'===i&&t.width<t.element[0].scrollWidth,a='scroll'===s||'auto'===s&&t.height<t.element[0].scrollHeight;return{width:a?e.position.scrollbarWidth():0,height:n?e.position.scrollbarWidth():0};
        },getWithinInfo:function(t){
            var i=e(t||window),s=e.isWindow(i[0]),n=!!i[0]&&9===i[0].nodeType;return{element:i,isWindow:s,isDocument:n,offset:i.offset()||{left:0,top:0},scrollLeft:i.scrollLeft(),scrollTop:i.scrollTop(),width:s||n?i.width():i.outerWidth(),height:s||n?i.height():i.outerHeight()};
        }},e.fn.position=function(n){
            if(!n||!n.of){
                return f.apply(this,arguments);
            }n=e.extend({},n);var p,m,g,v,y,b,_=e(n.of),x=e.position.getWithinInfo(n.within),w=e.position.getScrollInfo(x),k=(n.collision||'flip').split(' '),T={};return b=s(_),_[0].preventDefault&&(n.at='left top'),m=b.width,g=b.height,v=b.offset,y=e.extend({},v),e.each(['my','at'],function(){
                var e,t,i=(n[this]||'').split(' ');1===i.length&&(i=l.test(i[0])?i.concat(['center']):u.test(i[0])?['center'].concat(i):['center','center']),i[0]=l.test(i[0])?i[0]:'center',i[1]=u.test(i[1])?i[1]:'center',e=d.exec(i[0]),t=d.exec(i[1]),T[this]=[e?e[0]:0,t?t[0]:0],n[this]=[c.exec(i[0])[0],c.exec(i[1])[0]];
            }),1===k.length&&(k[1]=k[0]),'right'===n.at[0]?y.left+=m:'center'===n.at[0]&&(y.left+=m/2),'bottom'===n.at[1]?y.top+=g:'center'===n.at[1]&&(y.top+=g/2),p=t(T.at,m,g),y.left+=p[0],y.top+=p[1],this.each(function(){
                var s,l,u=e(this),d=u.outerWidth(),c=u.outerHeight(),f=i(this,'marginLeft'),b=i(this,'marginTop'),D=d+f+i(this,'marginRight')+w.width,S=c+b+i(this,'marginBottom')+w.height,M=e.extend({},y),C=t(T.my,u.outerWidth(),u.outerHeight());'right'===n.my[0]?M.left-=d:'center'===n.my[0]&&(M.left-=d/2),'bottom'===n.my[1]?M.top-=c:'center'===n.my[1]&&(M.top-=c/2),M.left+=C[0],M.top+=C[1],a||(M.left=h(M.left),M.top=h(M.top)),s={marginLeft:f,marginTop:b},e.each(['left','top'],function(t,i){
            ...
            var i,s=t.within,n=s.isWindow?s.scrollLeft:s.offset.left,a=s.width,r=e.left-t.collisionPosition.marginLeft,h=n-r,l=r+t.collisionWidth-a-n;t.collisionWidth>a?h>0&&0>=l?(i=e.left+h+t.collisionWidth-a-n,e.left+=h-i):e.left=l>0&&0>=h?n:h>l?n+a-t.collisionWidth:n:h>0?e.left+=h:l>0?e.left-=l:e.left=o(e.left-r,e.left);
        },top:function(e,t){
            var i,s=t.within,n=s.isWindow?s.scrollTop:s.offset.top,a=t.within.height,r=e.top-t.collisionPosition.marginTop,h=n-r,l=r+t.collisionHeight-a-n;t.collisionHeight>a?h>0&&0>=l?(i=e.top+h+t.collisionHeight-a-n,e.top+=h-i):e.top=l>0&&0>=h?n:h>l?n+a-t.collisionHeight:n:h>0?e.top+=h:l>0?e.top-=l:e.top=o(e.top-r,e.top);
        }},flip:{left:function(e,t){
            var i,s,n=t.within,a=n.offset.left+n.scrollLeft,o=n.width,h=n.isWindow?n.scrollLeft:n.offset.left,l=e.left-t.collisionPosition.marginLeft,u=l-h,d=l+t.collisionWidth-o-h,c='left'===t.my[0]?-t.elemWidth:'right'===t.my[0]?t.elemWidth:0,p='left'===t.at[0]?t.targetWidth:'right'===t.at[0]?-t.targetWidth:0,f=-2*t.offset[0];0>u?(i=e.left+c+p+f+t.collisionWidth-o-a,(0>i||r(u)>i)&&(e.left+=c+p+f)):d>0&&(s=e.left-t.collisionPosition.marginLeft+c+p+f-h,(s>0||d>r(s))&&(e.left+=c+p+f));
        },top:function(e,t){
            var i,s,n=t.within,a=n.offset.top+n.scrollTop,o=n.height,h=n.isWindow?n.scrollTop:n.offset.top,l=e.top-t.collisionPosition.marginTop,u=l-h,d=l+t.collisionHeight-o-h,c='top'===t.my[1],p=c?-t.elemHeight:'bottom'===t.my[1]?t.elemHeight:0,f='top'===t.at[1]?t.targetHeight:'bottom'===t.at[1]?-t.targetHeight:0,m=-2*t.offset[1];0>u?(s=e.top+p+f+m+t.collisionHeight-o-a,(0>s||r(u)>s)&&(e.top+=p+f+m)):d>0&&(i=e.top-t.collisionPosition.marginTop+p+f+m-h,(i>0||d>r(i))&&(e.top+=p+f+m));
        }},flipfit:{left:function(){
            e.ui.position.flip.left.apply(this,arguments),e.ui.position.fit.left.apply(this,arguments);
        },top:function(){
            e.ui.position.flip.top.apply(this,arguments),e.ui.position.fit.top.apply(this,arguments);
        }}},function(){
            var t,i,s,n,o,r=document.getElementsByTagName('body')[0],h=document.createElement('div');t=document.createElement(r?'div':'body'),s={visibility:'hidden',width:0,height:0,border:0,margin:0,background:'none'},r&&e.extend(s,{position:'absolute',left:'-1000px',top:'-1000px'});for(o in s){
                t.style[o]=s[o];
        ...
        var i=this.document[0];if(this.handleElement.is(t.target)){
            try{
        ...
        var i=this.options,s=e.isFunction(i.helper),n=s?e(i.helper.apply(this.element[0],[t])):'clone'===i.helper?this.element.clone().removeAttr('id'):this.element;return n.parents('body').length||n.appendTo('parent'===i.appendTo?this.element[0].parentNode:i.appendTo),s&&n[0]===this.element[0]&&this._setPositionRelative(),n[0]===this.element[0]||/(fixed|absolute)/.test(n.css('position'))||n.css('position','absolute'),n;
        ...
        if('relative'!==this.cssPosition){
            return{top:0,left:0};
        }var e=this.element.position(),t=this._isRootNode(this.scrollParent[0]);return{top:e.top-(parseInt(this.helper.css('top'),10)||0)+(t?0:this.scrollParent.scrollTop()),left:e.left-(parseInt(this.helper.css('left'),10)||0)+(t?0:this.scrollParent.scrollLeft())};
        ...
        var n=e('body'),a=s.options;n.css('cursor')&&(a._cursor=n.css('cursor')),n.css('cursor',a.cursor);
    },stop:function(t,i,s){
        var n=s.options;n._cursor&&e('body').css('cursor',n._cursor);
    }}),e.ui.plugin.add('draggable','opacity',{start:function(t,i,s){
        var n=e(i.helper),a=s.options;n.css('opacity')&&(a._opacity=n.css('opacity')),n.css('opacity',a.opacity);
    },stop:function(t,i,s){
        var n=s.options;n._opacity&&e(i.helper).css('opacity',n._opacity);
    }}),e.ui.plugin.add('draggable','scroll',{start:function(e,t,i){
        i.scrollParentNotHidden||(i.scrollParentNotHidden=i.helper.scrollParent(!1)),i.scrollParentNotHidden[0]!==i.document[0]&&'HTML'!==i.scrollParentNotHidden[0].tagName&&(i.overflowOffset=i.scrollParentNotHidden.offset());
    },drag:function(t,i,s){
        var n=s.options,a=!1,o=s.scrollParentNotHidden[0],r=s.document[0];o!==r&&'HTML'!==o.tagName?(n.axis&&'x'===n.axis||(s.overflowOffset.top+o.offsetHeight-t.pageY<n.scrollSensitivity?o.scrollTop=a=o.scrollTop+n.scrollSpeed:t.pageY-s.overflowOffset.top<n.scrollSensitivity&&(o.scrollTop=a=o.scrollTop-n.scrollSpeed)),n.axis&&'y'===n.axis||(s.overflowOffset.left+o.offsetWidth-t.pageX<n.scrollSensitivity?o.scrollLeft=a=o.scrollLeft+n.scrollSpeed:t.pageX-s.overflowOffset.left<n.scrollSensitivity&&(o.scrollLeft=a=o.scrollLeft-n.scrollSpeed))):(n.axis&&'x'===n.axis||(t.pageY-e(r).scrollTop()<n.scrollSensitivity?a=e(r).scrollTop(e(r).scrollTop()-n.scrollSpeed):e(window).height()-(t.pageY-e(r).scrollTop())<n.scrollSensitivity&&(a=e(r).scrollTop(e(r).scrollTop()+n.scrollSpeed))),n.axis&&'y'===n.axis||(t.pageX-e(r).scrollLeft()<n.scrollSensitivity?a=e(r).scrollLeft(e(r).scrollLeft()-n.scrollSpeed):e(window).width()-(t.pageX-e(r).scrollLeft())<n.scrollSensitivity&&(a=e(r).scrollLeft(e(r).scrollLeft()+n.scrollSpeed)))),a!==!1&&e.ui.ddmanager&&!n.dropBehaviour&&e.ui.ddmanager.prepareOffsets(s,t);
        ...
        var n=s.options;s.snapElements=[],e(n.snap.constructor!==String?n.snap.items||':data(ui-draggable)':n.snap).each(function(){
            var t=e(this),i=t.offset();this!==s.element[0]&&s.snapElements.push({item:this,width:t.outerWidth(),height:t.outerHeight(),top:i.top,left:i.left});
        });
    },drag:function(t,i,s){
        var n,a,o,r,h,l,u,d,c,p,f=s.options,m=f.snapTolerance,g=i.offset.left,v=g+s.helperProportions.width,y=i.offset.top,b=y+s.helperProportions.height;for(c=s.snapElements.length-1;c>=0;c--){
        ...
        var n=e(i.helper),a=s.options;n.css('zIndex')&&(a._zIndex=n.css('zIndex')),n.css('zIndex',a.zIndex);
    },stop:function(t,i,s){
        ...
        var t,i=this.options,s=i.accept;this.isover=!1,this.isout=!0,this.accept=e.isFunction(s)?s:function(e){
            return e.is(s);
        ...
        function e(e,t,i){
            ...
            if(!i.offset){
                return!1;
            }var a=(t.positionAbs||t.position.absolute).left+t.margins.left,o=(t.positionAbs||t.position.absolute).top+t.margins.top,r=a+t.helperProportions.width,h=o+t.helperProportions.height,l=i.offset.left,u=i.offset.top,d=l+i.proportions().width,c=u+i.proportions().height;switch(s){
                case'fit':return a>=l&&d>=r&&o>=u&&c>=h;case'intersect':return a+t.helperProportions.width/2>l&&d>r-t.helperProportions.width/2&&o+t.helperProportions.height/2>u&&c>h-t.helperProportions.height/2;case'pointer':return e(n.pageY,u,i.proportions().height)&&e(n.pageX,l,i.proportions().width);case'touch':return(o>=u&&c>=o||h>=u&&c>=h||u>o&&h>c)&&(a>=l&&d>=a||r>=l&&d>=r||l>a&&r>d);default:return!1;
            }
        };
        ...
        t.options.refreshPositions&&e.ui.ddmanager.prepareOffsets(t,i),e.each(e.ui.ddmanager.droppables[t.options.scope]||[],function(){
            if(!this.options.disabled&&!this.greedyChild&&this.visible){
                var s,n,a,o=e.ui.intersect(t,this,this.options.tolerance,i),r=!o&&this.isover?'isout':o&&!this.isover?'isover':null;r&&(this.options.greedy&&(n=this.options.scope,a=this.element.parents(':data(ui-droppable)').filter(function(){
        ...
        if('hidden'===e(t).css('overflow')){
            return!1;
        }var s=i&&'left'===i?'scrollLeft':'scrollTop',n=!1;return t[s]>0?!0:(t[s]=1,n=t[s]>0,t[s]=0,n);
    },_create:function(){
        ...
        var i,s,n,a=this.options,o=this.element;return this.resizing=!0,this._renderProxy(),i=this._num(this.helper.css('left')),s=this._num(this.helper.css('top')),a.containment&&(i+=e(a.containment).scrollLeft()||0,s+=e(a.containment).scrollTop()||0),this.offset=this.helper.offset(),this.position={left:i,top:s},this.size=this._helper?{width:this.helper.width(),height:this.helper.height()}:{width:o.width(),height:o.height()},this.originalSize=this._helper?{width:o.outerWidth(),height:o.outerHeight()}:{width:o.width(),height:o.height()},this.sizeDiff={width:o.outerWidth()-o.width(),height:o.outerHeight()-o.height()},this.originalPosition={left:i,top:s},this.originalMousePosition={left:t.pageX,top:t.pageY},this.aspectRatio='number'==typeof a.aspectRatio?a.aspectRatio:this.originalSize.width/this.originalSize.height||1,n=e('.ui-resizable-'+this.axis).css('cursor'),e('body').css('cursor','auto'===n?this.axis+'-resize':n),o.addClass('ui-resizable-resizing'),this._propagate('start',t),!0;
    },_mouseDrag:function(t){
        var i,s,n=this.originalMousePosition,a=this.axis,o=t.pageX-n.left||0,r=t.pageY-n.top||0,h=this._change[a];return this._updatePrevProperties(),h?(i=h.apply(this,[t,o,r]),this._updateVirtualBoundaries(t.shiftKey),(this._aspectRatio||t.shiftKey)&&(i=this._updateRatio(i,t)),i=this._respectSize(i,t),this._updateCache(i),this._propagate('resize',t),s=this._applyChanges(),!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize(),e.isEmptyObject(s)||(this._updatePrevProperties(),this._trigger('resize',t,this.ui()),this._applyChanges()),!1):!1;
    },_mouseStop:function(t){
        this.resizing=!1;var i,s,n,a,o,r,h,l=this.options,u=this;return this._helper&&(i=this._proportionallyResizeElements,s=i.length&&/textarea/i.test(i[0].nodeName),n=s&&this._hasScroll(i[0],'left')?0:u.sizeDiff.height,a=s?0:u.sizeDiff.width,o={width:u.helper.width()-a,height:u.helper.height()-n},r=parseInt(u.element.css('left'),10)+(u.position.left-u.originalPosition.left)||null,h=parseInt(u.element.css('top'),10)+(u.position.top-u.originalPosition.top)||null,l.animate||this.element.css(e.extend(o,{top:h,left:r})),u.helper.height(u.size.height),u.helper.width(u.size.width),this._helper&&!l.animate&&this._proportionallyResize()),e('body').css('cursor','auto'),this.element.removeClass('ui-resizable-resizing'),this._propagate('stop',t),this._helper&&this.helper.remove(),!1;
        ...
        var t,i,s,n,a,o=this.options;a={minWidth:this._isNumber(o.minWidth)?o.minWidth:0,maxWidth:this._isNumber(o.maxWidth)?o.maxWidth:1/0,minHeight:this._isNumber(o.minHeight)?o.minHeight:0,maxHeight:this._isNumber(o.maxHeight)?o.maxHeight:1/0},(this._aspectRatio||e)&&(t=a.minHeight*this.aspectRatio,s=a.minWidth/this.aspectRatio,i=a.maxHeight*this.aspectRatio,n=a.maxWidth/this.aspectRatio,t>a.minWidth&&(a.minWidth=t),s>a.minHeight&&(a.minHeight=s),a.maxWidth>i&&(a.maxWidth=i),a.maxHeight>n&&(a.maxHeight=n)),this._vBoundaries=a;
    },_updateCache:function(e){
        this.offset=this.helper.offset(),this._isNumber(e.left)&&(this.position.left=e.left),this._isNumber(e.top)&&(this.position.top=e.top),this._isNumber(e.height)&&(this.size.height=e.height),this._isNumber(e.width)&&(this.size.width=e.width);
    },_updateRatio:function(e){
        var t=this.position,i=this.size,s=this.axis;return this._isNumber(e.height)?e.width=e.height*this.aspectRatio:this._isNumber(e.width)&&(e.height=e.width/this.aspectRatio),'sw'===s&&(e.left=t.left+(i.width-e.width),e.top=null),'nw'===s&&(e.top=t.top+(i.height-e.height),e.left=t.left+(i.width-e.width)),e;
        ...
        var t=e(this).resizable('instance'),i=t.options;e(i.alsoResize).each(function(){
        ...
        var s=e(this).resizable('instance'),n=s.options,a=s.originalSize,o=s.originalPosition,r={height:s.size.height-a.height||0,width:s.size.width-a.width||0,top:s.position.top-o.top||0,left:s.position.left-o.left||0};e(n.alsoResize).each(function(){
            var t=e(this),s=e(this).data('ui-resizable-alsoresize'),n={},a=t.parents(i.originalElement[0]).length?['width','height']:['width','height','top','left'];e.each(a,function(e,t){
        ...
        var t=e(this).resizable('instance'),i=t.options,s=t.size;t.ghost=t.originalElement.clone(),t.ghost.css({opacity:.25,display:'block',position:'relative',height:s.height,width:s.width,margin:0,left:0,top:0}).addClass('ui-resizable-ghost').addClass('string'==typeof i.ghost?i.ghost:''),t.ghost.appendTo(t.helper);
    },resize:function(){
        ...
        var s=null,n=!1,a=this;return this.reverting?!1:this.options.disabled||'static'===this.options.type?!1:(this._refreshItems(t),e(t.target).parents().each(function(){
        ...
        var i=this._getItemsAsjQuery(t&&t.connected),s=[];return t=t||{},e(i).each(function(){
            var i=(e(t.item||this).attr(t.attribute||'id')||'').match(t.expression||/(.+)[\-=_](.+)/);i&&s.push((t.key||i[1]+'[]')+'='+(t.key&&t.expression?i[1]:i[2]));
        }),!s.length&&t.key&&s.push(t.key+'='),s.join('&');
    },toArray:function(t){
        var i=this._getItemsAsjQuery(t&&t.connected),s=[];return t=t||{},i.each(function(){
        ...
        function i(){
            r.push(this);
        }var s,n,a,o,r=[],h=[],l=this._connectWith();if(l&&t){
        ...
        this.items=[],this.containers=[this];var i,s,n,a,o,r,h,l,u=this.items,d=[[e.isFunction(this.options.items)?this.options.items.call(this.element[0],t,{item:this.currentItem}):e(this.options.items,this.element),this]],c=this._connectWith();if(c&&this.ready){
        ...
        t=t||this;var i,s=t.options;s.placeholder&&s.placeholder.constructor!==String||(i=s.placeholder,s.placeholder={element:function(){
            var s=t.currentItem[0].nodeName.toLowerCase(),n=e('<'+s+'>',t.document[0]).addClass(i||t.currentItem[0].className+' ui-sortable-placeholder').removeClass('ui-sortable-helper');return'tbody'===s?t._createTrPlaceholder(t.currentItem.find('tr').eq(0),e('<tr>',t.document[0]).appendTo(n)):'tr'===s?t._createTrPlaceholder(t.currentItem,n):'img'===s&&n.attr('src',t.currentItem.attr('src')),i||n.css('visibility','hidden'),n;
        },update:function(e,n){
        ...
        var i,s,n,a,o,r,h,l,u,d,c=null,p=null;for(i=this.containers.length-1;i>=0;i--){
        ...
        if(!t.altKey&&!t.ctrlKey){
            var i=e.ui.keyCode,s=this.headers.length,n=this.headers.index(t.target),a=!1;switch(t.keyCode){
                case i.RIGHT:case i.DOWN:a=this.headers[(n+1)%s];break;case i.LEFT:case i.UP:a=this.headers[(n-1+s)%s];break;case i.SPACE:case i.ENTER:this._eventHandler(t);break;case i.HOME:a=this.headers[0];break;case i.END:a=this.headers[s-1];
        ...
        var t,i=this.options,s=i.heightStyle,n=this.element.parent();this.active=this._findActive(i.active).addClass('ui-accordion-header-active ui-state-active ui-corner-top').removeClass('ui-corner-all'),this.active.next().addClass('ui-accordion-content-active').show(),this.headers.attr('role','tab').each(function(){
            var t=e(this),i=t.uniqueId().attr('id'),s=t.next(),n=s.uniqueId().attr('id');t.attr('aria-controls',n),s.attr('aria-labelledby',i);
        }).next().attr('role','tabpanel'),this.headers.not(this.active).attr({'aria-selected':'false','aria-expanded':'false',tabIndex:-1}).next().attr({'aria-hidden':'true'}).hide(),this.active.length?this.active.attr({'aria-selected':'true','aria-expanded':'true',tabIndex:0}).next().attr({'aria-hidden':'false'}):this.headers.eq(0).attr('tabIndex',0),this._createIcons(),this._setupEvents(i.event),'fill'===s?(t=n.height(),this.element.siblings(':visible').each(function(){
            var i=e(this),s=i.css('position');'absolute'!==s&&'fixed'!==s&&(t-=i.outerHeight(!0));
        ...
        var i,s,n,a,o=!0;switch(t.keyCode){
            case e.ui.keyCode.PAGE_UP:this.previousPage(t);break;case e.ui.keyCode.PAGE_DOWN:this.nextPage(t);break;case e.ui.keyCode.HOME:this._move('first','first',t);break;case e.ui.keyCode.END:this._move('last','last',t);break;case e.ui.keyCode.UP:this.previous(t);break;case e.ui.keyCode.DOWN:this.next(t);break;case e.ui.keyCode.LEFT:this.collapse(t);break;case e.ui.keyCode.RIGHT:this.active&&!this.active.is('.ui-state-disabled')&&this.expand(t);break;case e.ui.keyCode.ENTER:case e.ui.keyCode.SPACE:this._activate(t);break;case e.ui.keyCode.ESCAPE:this.collapse(t);break;default:o=!1,s=this.previousFilter||'',n=String.fromCharCode(t.keyCode),a=!1,clearTimeout(this.filterTimer),n===s?a=!0:n=s+n,i=this._filterMenuItems(n),i=a&&-1!==i.index(this.active.next())?this.active.nextAll('.ui-menu-item'):i,i.length||(n=String.fromCharCode(t.keyCode),i=this._filterMenuItems(n)),i.length?(this.focus(t,i),this.previousFilter=n,this.filterTimer=this._delay(function(){
        ...
        var t,i,s=this,n=this.options.icons.submenu,a=this.element.find(this.options.menus);this.element.toggleClass('ui-menu-icons',!!this.element.find('.ui-icon').length),a.filter(':not(.ui-menu)').addClass('ui-menu ui-widget ui-widget-content ui-front').hide().attr({role:this.options.role,'aria-hidden':'true','aria-expanded':'false'}).each(function(){
            var t=e(this),i=t.parent(),s=e('<span>').addClass('ui-menu-icon ui-icon '+n).data('ui-menu-submenu-carat',!0);i.attr('aria-haspopup','true').prepend(s),t.attr('aria-labelledby',i.attr('id'));
        ...
        var i=t.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,'\\$&'),s=RegExp('^'+i,'i');return this.activeMenu.find(this.options.items).filter('.ui-menu-item').filter(function(){
            return s.test(e.trim(e(this).text()));
        });
    }}),e.widget('ui.autocomplete',{version:'1.11.4',defaultElement:'<input>',options:{appendTo:null,autoFocus:!1,delay:300,minLength:1,position:{my:'left top',at:'left bottom',collision:'none'},source:null,change:null,close:null,focus:null,open:null,response:null,search:null,select:null},requestIndex:0,pending:0,_create:function(){
        var t,i,s,n=this.element[0].nodeName.toLowerCase(),a='textarea'===n,o='input'===n;this.isMultiLine=a?!0:o?!1:this.element.prop('isContentEditable'),this.valueMethod=this.element[a||o?'val':'text'],this.isNewMenu=!0,this.element.addClass('ui-autocomplete-input').attr('autocomplete','off'),this._on(this.element,{keydown:function(n){
            if(this.element.prop('readOnly')){
                return t=!0,s=!0,i=!0,void 0;
            }t=!1,s=!1,i=!1;var a=e.ui.keyCode;switch(n.keyCode){
                case a.PAGE_UP:t=!0,this._move('previousPage',n);break;case a.PAGE_DOWN:t=!0,this._move('nextPage',n);break;case a.UP:t=!0,this._keyEvent('previous',n);break;case a.DOWN:t=!0,this._keyEvent('next',n);break;case a.ENTER:this.menu.active&&(t=!0,n.preventDefault(),this.menu.select(n));break;case a.TAB:this.menu.active&&this.menu.select(n);break;case a.ESCAPE:this.menu.element.is(':visible')&&(this.isMultiLine||this._value(this.term),this.close(n),n.preventDefault());break;default:i=!0,this._searchTimeout(n);
            }
        },keypress:function(s){
            if(t){
        ...
        clearTimeout(this.searching),this.searching=this._delay(function(){
            var t=this.term===this._value(),i=this.menu.element.is(':visible'),s=e.altKey||e.ctrlKey||e.metaKey||e.shiftKey;(!t||t&&!i&&!s)&&(this.selectedItem=null,this.search(null,e));
        },this.options.delay);
    },search:function(e,t){
    ...
    }}),e.ui.autocomplete;var c,p='ui-button ui-widget ui-state-default ui-corner-all',f='ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only',m=function(){
            var t=e(this);setTimeout(function(){
                t.find(':ui-button').button('refresh');
            },1);
        },g=function(t){
            var i=t.name,s=t.form,n=e([]);return i&&(i=i.replace(/'/g,'\\\''),n=s?e(s).find('[name=\''+i+'\'][type=radio]'):e('[name=\''+i+'\'][type=radio]',t.ownerDocument).filter(function(){
                return!this.form;
            })),n;
        ...
        this.element.closest('form').unbind('reset'+this.eventNamespace).bind('reset'+this.eventNamespace,m),'boolean'!=typeof this.options.disabled?this.options.disabled=!!this.element.prop('disabled'):this.element.prop('disabled',this.options.disabled),this._determineButtonType(),this.hasTitle=!!this.buttonElement.attr('title');var t=this,i=this.options,s='checkbox'===this.type||'radio'===this.type,n=s?'':'ui-state-active';null===i.label&&(i.label='input'===this.type?this.buttonElement.val():this.buttonElement.html()),this._hoverable(this.buttonElement),this.buttonElement.addClass(p).attr('role','button').bind('mouseenter'+this.eventNamespace,function(){
            ...
            if(i.disabled){
                return!1;
            }e(this).addClass('ui-state-active'),t.buttonElement.attr('aria-pressed','true');var s=t.element[0];g(s).not(s).map(function(){
        ...
        }var t=this.buttonElement.removeClass(f),i=e('<span></span>',this.document[0]).addClass('ui-button-text').html(this.options.label).appendTo(t.empty()).text(),s=this.options.icons,n=s.primary&&s.secondary,a=[];s.primary||s.secondary?(this.options.text&&a.push('ui-button-text-icon'+(n?'s':s.primary?'-primary':'-secondary')),s.primary&&t.prepend('<span class=\'ui-button-icon-primary ui-icon '+s.primary+'\'></span>'),s.secondary&&t.append('<span class=\'ui-button-icon-secondary ui-icon '+s.secondary+'\'></span>'),this.options.text||(a.push(n?'ui-button-icons-only':'ui-button-icon-only'),this.hasTitle||t.attr('title',e.trim(i)))):a.push('ui-button-text-only'),t.addClass(a.join(' '));
        ...
        var t='rtl'===this.element.css('direction'),i=this.element.find(this.options.items),s=i.filter(':ui-button');i.not(':ui-button').button(),s.button('refresh'),this.buttons=i.map(function(){
            return e(this).button('widget')[0];
    ...
    }}),e.ui.button,e.extend(e.ui,{datepicker:{version:'1.11.4'}});var v;e.extend(n.prototype,{markerClassName:'hasDatepicker',maxRows:4,_widgetDatepicker:function(){
        return this.dpDiv;
        ...
        if(this._get(e,'autoSize')&&!e.inline){
            var t,i,s,n,a=new Date(2009,11,20),o=this._get(e,'dateFormat');o.match(/[DM]/)&&(t=function(e){
        ...
        var i,s,n=e(t),a=e.data(t,'datepicker');n.hasClass(this.markerClassName)&&(i=t.nodeName.toLowerCase(),'input'===i?(t.disabled=!1,a.trigger.filter('button').each(function(){
            this.disabled=!1;
        ...
        var i,s,n=e(t),a=e.data(t,'datepicker');n.hasClass(this.markerClassName)&&(i=t.nodeName.toLowerCase(),'input'===i?(t.disabled=!0,a.trigger.filter('button').each(function(){
            this.disabled=!0;
        ...
        var i,s,n,a=e.datepicker._getInst(t.target),o=!0,r=a.dpDiv.is('.ui-datepicker-rtl');if(a._keyEvent=!0,e.datepicker._datepickerShowing){
            switch(t.keyCode){
                case 9:e.datepicker._hideDatepicker(),o=!1;break;case 13:return n=e('td.'+e.datepicker._dayOverClass+':not(.'+e.datepicker._currentClass+')',a.dpDiv),n[0]&&e.datepicker._selectDay(t.target,a.selectedMonth,a.selectedYear,n[0]),i=e.datepicker._get(a,'onSelect'),i?(s=e.datepicker._formatDate(a),i.apply(a.input?a.input[0]:null,[s,a])):e.datepicker._hideDatepicker(),!1;case 27:e.datepicker._hideDatepicker();break;case 33:e.datepicker._adjustDate(t.target,t.ctrlKey?-e.datepicker._get(a,'stepBigMonths'):-e.datepicker._get(a,'stepMonths'),'M');break;case 34:e.datepicker._adjustDate(t.target,t.ctrlKey?+e.datepicker._get(a,'stepBigMonths'):+e.datepicker._get(a,'stepMonths'),'M');break;case 35:(t.ctrlKey||t.metaKey)&&e.datepicker._clearDate(t.target),o=t.ctrlKey||t.metaKey;break;case 36:(t.ctrlKey||t.metaKey)&&e.datepicker._gotoToday(t.target),o=t.ctrlKey||t.metaKey;break;case 37:(t.ctrlKey||t.metaKey)&&e.datepicker._adjustDate(t.target,r?1:-1,'D'),o=t.ctrlKey||t.metaKey,t.originalEvent.altKey&&e.datepicker._adjustDate(t.target,t.ctrlKey?-e.datepicker._get(a,'stepBigMonths'):-e.datepicker._get(a,'stepMonths'),'M');break;case 38:(t.ctrlKey||t.metaKey)&&e.datepicker._adjustDate(t.target,-7,'D'),o=t.ctrlKey||t.metaKey;break;case 39:(t.ctrlKey||t.metaKey)&&e.datepicker._adjustDate(t.target,r?-1:1,'D'),o=t.ctrlKey||t.metaKey,t.originalEvent.altKey&&e.datepicker._adjustDate(t.target,t.ctrlKey?+e.datepicker._get(a,'stepBigMonths'):+e.datepicker._get(a,'stepMonths'),'M');break;case 40:(t.ctrlKey||t.metaKey)&&e.datepicker._adjustDate(t.target,7,'D'),o=t.ctrlKey||t.metaKey;break;default:o=!1;
            }
        }else {
        ...
        var i,s=e.datepicker._getInst(t.target);if(s.input.val()!==s.lastVal){
            try{
        ...
        if(e.datepicker._curInst){
            var i=e(t.target),s=e.datepicker._getInst(i[0]);(i[0].id!==e.datepicker._mainDivId&&0===i.parents('#'+e.datepicker._mainDivId).length&&!i.hasClass(e.datepicker.markerClassName)&&!i.closest('.'+e.datepicker._triggerClass).length&&e.datepicker._datepickerShowing&&(!e.datepicker._inDialog||!e.blockUI)||i.hasClass(e.datepicker.markerClassName)&&e.datepicker._curInst!==s)&&e.datepicker._hideDatepicker();
        }
    },_adjustDate:function(t,i,s){
        var n=e(t),a=this._getInst(n[0]);this._isDisabledDatepicker(n[0])||(this._adjustInstDate(a,i+('M'===s?this._get(a,'showCurrentAtPos'):0),s),this._updateDatepicker(a));
    },_gotoToday:function(t){
        var i,s=e(t),n=this._getInst(s[0]);this._get(n,'gotoCurrent')&&n.currentDay?(n.selectedDay=n.currentDay,n.drawMonth=n.selectedMonth=n.currentMonth,n.drawYear=n.selectedYear=n.currentYear):(i=new Date,n.selectedDay=i.getDate(),n.drawMonth=n.selectedMonth=i.getMonth(),n.drawYear=n.selectedYear=i.getFullYear()),this._notifyChange(n),this._adjustDate(s);
    },_selectMonthYear:function(t,i,s){
        var n=e(t),a=this._getInst(n[0]);a['selected'+('M'===s?'Month':'Year')]=a['draw'+('M'===s?'Month':'Year')]=parseInt(i.options[i.selectedIndex].value,10),this._notifyChange(a),this._adjustDate(n);
    },_selectDay:function(t,i,s,n){
        var a,o=e(t);e(n).hasClass(this._unselectableClass)||this._isDisabledDatepicker(o[0])||(a=this._getInst(o[0]),a.selectedDay=a.currentDay=e('a',n).html(),a.selectedMonth=a.currentMonth=i,a.selectedYear=a.currentYear=s,this._selectDate(t,this._formatDate(a,a.currentDay,a.currentMonth,a.currentYear)));
        ...
        var i,s,n,a=this._get(t,'altField');a&&(i=this._get(t,'altFormat')||this._get(t,'dateFormat'),s=this._getDate(t),n=this.formatDate(i,s,this._getFormatConfig(t)),e(a).each(function(){
            e(this).val(n);
        }));
        ...
        if(null==t||null==i){
            ...
            return null;
                ...
                var t=_(e),s='@'===e?14:'!'===e?20:'y'===e&&t?4:'o'===e?3:2,n='y'===e?s:1,a=RegExp('^\\d{'+n+','+s+'}'),o=i.substring(h).match(a);if(!o){
        ...
        var t,i='',s=!1,n=function(i){
            ...
            if(s){
                ...
                switch(e.charAt(t)){
                    case'd':case'm':case'y':case'@':i+='0123456789';break;case'D':case'M':return null;case'\'':n('\'')?i+='\'':s=!0;break;default:i+=e.charAt(t);
                }
            }
        }return i;
    },_get:function(e,t){
        ...
        if(e.input.val()!==e.lastVal){
            var i=this._get(e,'dateFormat'),s=e.lastVal=e.input?e.input.val():null,n=this._getDefaultDate(e),a=n,o=this._getFormatConfig(e);try{
        ...
        var n=function(e){
                ...
                try{
                    ...
                    switch(l[2]||'d'){
                        case'd':case'D':r+=parseInt(l[1],10);break;case'w':case'W':r+=7*parseInt(l[1],10);break;case'm':case'M':o+=parseInt(l[1],10),r=Math.min(r,e.datepicker._getDaysInMonth(a,o));break;case'y':case'Y':a+=parseInt(l[1],10),r=Math.min(r,e.datepicker._getDaysInMonth(a,o));
                    }l=h.exec(i);
        ...
        var s=!t,n=e.selectedMonth,a=e.selectedYear,o=this._restrictMinMax(e,this._determineDate(e,t,new Date));e.selectedDay=e.currentDay=o.getDate(),e.drawMonth=e.selectedMonth=e.currentMonth=o.getMonth(),e.drawYear=e.selectedYear=e.currentYear=o.getFullYear(),n===e.selectedMonth&&a===e.selectedYear||i||this._notifyChange(e),this._adjustInstDate(e),e.input&&e.input.val(s?'':this._formatDate(e));
    },_getDate:function(e){
        ...
        var i=this._get(t,'stepMonths'),s='#'+t.id.replace(/\\\\/g,'\\');t.dpDiv.find('[data-handler]').map(function(){
            var t={prev:function(){
            ...
            for(k='',this.maxRows=4,T=0;K[1]>T;T++){
                if(D=this._daylightSavingAdjust(new Date(et,Z,e.selectedDay)),S=' ui-corner-all',M='',Q){
                    if(M+='<div class=\'ui-datepicker-group',K[1]>1){
                        switch(T){
                            case 0:M+=' ui-datepicker-group-first',S=' ui-corner-'+(Y?'right':'left');break;case K[1]-1:M+=' ui-datepicker-group-last',S=' ui-corner-'+(Y?'left':'right');break;default:M+=' ui-datepicker-group-middle',S='';
                        }
                    }M+='\'>';
        ...
        var h,l,u,d,c,p,f,m,g=this._get(e,'changeMonth'),v=this._get(e,'changeYear'),y=this._get(e,'showMonthAfterYear'),b='<div class=\'ui-datepicker-title\'>',_='';if(a||!g){
        ...
        var s=e.drawYear+('Y'===i?t:0),n=e.drawMonth+('M'===i?t:0),a=Math.min(e.selectedDay,this._getDaysInMonth(s,n))+('D'===i?t:0),o=this._restrictMinMax(e,this._daylightSavingAdjust(new Date(s,n,a)));e.selectedDay=o.getDate(),e.drawMonth=e.selectedMonth=o.getMonth(),e.drawYear=e.selectedYear=o.getFullYear(),('M'===i||'Y'===i)&&this._notifyChange(e);
    },_restrictMinMax:function(e,t){
        var i=this._getMinMaxDate(e,'min'),s=this._getMinMaxDate(e,'max'),n=i&&i>t?i:t;return s&&n>s?s:n;
        ...
        var n=this._getNumberOfMonths(e),a=this._daylightSavingAdjust(new Date(i,s+(0>t?t:n[0]*n[1]),1));return 0>t&&a.setDate(this._getDaysInMonth(a.getFullYear(),a.getMonth())),this._isInRange(e,a);
    },_isInRange:function(e,t){
        var i,s,n=this._getMinMaxDate(e,'min'),a=this._getMinMaxDate(e,'max'),o=null,r=null,h=this._get(e,'yearRange');return h&&(i=h.split(':'),s=(new Date).getFullYear(),o=parseInt(i[0],10),r=parseInt(i[1],10),i[0].match(/[+\-].*/)&&(o+=s),i[1].match(/[+\-].*/)&&(r+=s)),(!n||t.getTime()>=n.getTime())&&(!a||t.getTime()<=a.getTime())&&(!o||t.getFullYear()>=o)&&(!r||r>=t.getFullYear());
        ...
        var e,t=this.originalPosition;this._untrackInstance(),this._destroyOverlay(),this.element.removeUniqueId().removeClass('ui-dialog-content ui-widget-content').css(this.originalCss).detach(),this.uiDialog.stop(!0,!0).remove(),this.originalTitle&&this.element.attr('title',this.originalTitle),e=t.parent.children().eq(t.index),e.length&&e[0]!==this.element[0]?e.before(this.element):t.parent.append(this.element);
    },widget:function(){
        return this.uiDialog;
    },disable:e.noop,enable:e.noop,close:function(t){
        var i,s=this;if(this._isOpen&&this._trigger('beforeClose',t)!==!1){
        ...
        var s=!1,n=this.uiDialog.siblings('.ui-front:visible').map(function(){
            ...
            }).get(),a=Math.max.apply(null,n);return a>=+this.uiDialog.css('z-index')&&(this.uiDialog.css('z-index',a+1),s=!0),s&&!i&&this._trigger('focus',t),s;
    },open:function(){
        var t=this;
        ...
        function i(){
            var t=this.document[0].activeElement,i=this.uiDialog[0]===t||e.contains(this.uiDialog[0],t);i||this._focusTabbable();
        ...
        this.uiDialog=e('<div>').addClass('ui-dialog ui-widget ui-widget-content ui-corner-all ui-front '+this.options.dialogClass).hide().attr({tabIndex:-1,role:'dialog'}).appendTo(this._appendTo()),this._on(this.uiDialog,{keydown:function(t){
            if(this.options.closeOnEscape&&!t.isDefaultPrevented()&&t.keyCode&&t.keyCode===e.ui.keyCode.ESCAPE){
                ...
                var i=this.uiDialog.find(':tabbable'),s=i.filter(':first'),n=i.filter(':last');t.target!==n[0]&&t.target!==this.uiDialog[0]||t.shiftKey?t.target!==s[0]&&t.target!==this.uiDialog[0]||!t.shiftKey||(this._delay(function(){
                    n.focus();
        ...
        var t=this,i=this.options.buttons;return this.uiDialogButtonPane.remove(),this.uiButtonSet.empty(),e.isEmptyObject(i)||e.isArray(i)&&!i.length?(this.uiDialog.removeClass('ui-dialog-buttons'),void 0):(e.each(i,function(i,s){
        ...
        function t(e){
            ...
            var o=a.offset.left-i.document.scrollLeft(),r=a.offset.top-i.document.scrollTop();s.position={my:'left top',at:'left'+(o>=0?'+':'')+o+' '+'top'+(r>=0?'+':'')+r,of:i.window},e(this).removeClass('ui-dialog-dragging'),i._unblockFrames(),i._trigger('dragStop',n,t(a));
        }});
        ...
        function t(e){
            ...
            var o=i.uiDialog.offset(),r=o.left-i.document.scrollLeft(),h=o.top-i.document.scrollTop();s.height=i.uiDialog.height(),s.width=i.uiDialog.width(),s.position={my:'left top',at:'left'+(r>=0?'+':'')+r+' '+'top'+(h>=0?'+':'')+h,of:i.window},e(this).removeClass('ui-dialog-resizing'),i._unblockFrames(),i._trigger('resizeStop',n,t(a));
        }}).css('position',a);
        ...
        var t=this._trackingInstances(),i=e.inArray(this,t);-1!==i&&t.splice(i,1);
        ...
        var i=this,s=!1,n={};e.each(t,function(e,t){
        ...
        var e,t,i,s=this.options;this.element.show().css({width:'auto',minHeight:0,maxHeight:'none',height:0}),s.minWidth>s.width&&(s.width=s.minWidth),e=this.uiDialog.css({height:'auto',width:s.width}).outerHeight(),t=Math.max(0,s.minHeight-e),i='number'==typeof s.maxHeight?Math.max(0,s.maxHeight-e):'none','auto'===s.height?this.element.css({minHeight:t,maxHeight:i,height:'auto'}):this.element.height(Math.max(0,s.height-e)),this.uiDialog.is(':data(ui-resizable)')&&this.uiDialog.resizable('option','minHeight',this._minHeight());
        ...
        this.menu.empty();var e,t=this.element.find('option');t.length&&(this._parseOptions(t),this._renderMenu(this.menu,this.items),this.menuInstance.refresh(),this.menuItems=this.menu.find('li').not('.ui-selectmenu-optgroup'),e=this._getSelectedItem(),this.menuInstance.focus(null,e),this._setAria(e.data('ui-selectmenu-item')),this._setOption('disabled',this.element.prop('disabled')));
    },open:function(e){
        ...
        var s=this,n='';e.each(i,function(i,a){
        ...
        var i,s,n='.ui-menu-item';this.isOpen?i=this.menuItems.eq(this.focusIndex):(i=this.menuItems.eq(this.element[0].selectedIndex),n+=':not(.ui-state-disabled)'),s='first'===e||'last'===e?i['first'===e?'prevAll':'nextAll'](n).eq(-1):i[e+'All'](n).eq(0),s.length&&this.menuInstance.focus(t,s);
        ...
        var i=!0;switch(t.keyCode){
            case e.ui.keyCode.TAB:case e.ui.keyCode.ESCAPE:this.close(t),i=!1;break;case e.ui.keyCode.ENTER:this.isOpen&&this._selectFocusedItem(t);break;case e.ui.keyCode.UP:t.altKey?this._toggle(t):this._move('prev',t);break;case e.ui.keyCode.DOWN:t.altKey?this._toggle(t):this._move('next',t);break;case e.ui.keyCode.SPACE:this.isOpen?this._selectFocusedItem(t):this._toggle(t);break;case e.ui.keyCode.LEFT:this._move('prev',t);break;case e.ui.keyCode.RIGHT:this._move('next',t);break;case e.ui.keyCode.HOME:case e.ui.keyCode.PAGE_UP:this._move('first',t);break;case e.ui.keyCode.END:case e.ui.keyCode.PAGE_DOWN:this._move('last',t);break;default:this.menu.trigger(t),i=!1;
        }i&&t.preventDefault();
        ...
        var i=[];t.each(function(t,s){
            var n=e(s),a=n.parent('optgroup');i.push({element:n,index:t,value:n.val(),label:n.text(),optgroup:a.attr('label')||'',disabled:a.prop('disabled')||n.prop('disabled')});
        }),this.items=i;
    },_destroy:function(){
        ...
        var t,i,s=this.options,n=this.element.find('.ui-slider-handle').addClass('ui-state-default ui-corner-all'),a='<span class=\'ui-slider-handle ui-state-default ui-corner-all\' tabindex=\'0\'></span>',o=[];for(i=s.values&&s.values.length||1,n.length>i&&(n.slice(i).remove(),n=n.slice(0,i)),t=n.length;i>t;t++){
            o.push(a);
        }this.handles=n.add(e(o.join('')).appendTo(this.element)),this.handle=this.handles.eq(0),this.handles.each(function(t){
            e(this).data('ui-slider-handle-index',t);
        });
    },_createRange:function(){
        var t=this.options,i='';t.range?(t.range===!0&&(t.values?t.values.length&&2!==t.values.length?t.values=[t.values[0],t.values[0]]:e.isArray(t.values)&&(t.values=t.values.slice(0)):t.values=[this._valueMin(),this._valueMin()]),this.range&&this.range.length?this.range.removeClass('ui-slider-range-min ui-slider-range-max').css({left:'',bottom:''}):(this.range=e('<div></div>').appendTo(this.element),i='ui-slider-range ui-widget-header ui-corner-all'),this.range.addClass(i+('min'===t.range||'max'===t.range?' ui-slider-range-'+t.range:''))):(this.range&&this.range.remove(),this.range=null);
    },_setupEvents:function(){
        this._off(this.handles),this._on(this.handles,this._handleEvents),this._hoverable(this.handles),this._focusable(this.handles);
    },_destroy:function(){
        this.handles.remove(),this.range&&this.range.remove(),this.element.removeClass('ui-slider ui-slider-horizontal ui-slider-vertical ui-widget ui-widget-content ui-corner-all'),this._mouseDestroy();
    },_mouseCapture:function(t){
        var i,s,n,a,o,r,h,l,u=this,d=this.options;return d.disabled?!1:(this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()},this.elementOffset=this.element.offset(),i={x:t.pageX,y:t.pageY},s=this._normValueFromMouse(i),n=this._valueMax()-this._valueMin()+1,this.handles.each(function(t){
        ...
        var t={x:e.pageX,y:e.pageY},i=this._normValueFromMouse(t);return this._slide(e,this._handleIndex,i),!1;
        ...
        var s,n=0;switch('range'===t&&this.options.range===!0&&('min'===i?(this.options.value=this._values(0),this.options.values=null):'max'===i&&(this.options.value=this._values(this.options.values.length-1),this.options.values=null)),e.isArray(this.options.values)&&(n=this.options.values.length),'disabled'===t&&this.element.toggleClass('ui-state-disabled',!!i),this._super(t,i),t){
            case'orientation':this._detectOrientation(),this.element.removeClass('ui-slider-horizontal ui-slider-vertical').addClass('ui-slider-'+this.orientation),this._refreshValue(),this.handles.css('horizontal'===i?'bottom':'left','');break;case'value':this._animateOff=!0,this._refreshValue(),this._change(null,0),this._animateOff=!1;break;case'values':for(this._animateOff=!0,this._refreshValue(),s=0;n>s;s+=1){
                this._change(null,s);
        ...
        var e=this.options.max,t=this._valueMin(),i=this.options.step,s=Math.floor(+(e-t).toFixed(this._precision())/i)*i;e=s+t,this.max=parseFloat(e.toFixed(this._precision()));
    },_precision:function(){
        ...
        var t=''+e,i=t.indexOf('.');return-1===i?0:t.length-i-1;
    },_valueMin:function(){
        return this.options.min;
    },_valueMax:function(){
        return this.max;
    },_refreshValue:function(){
        var t,i,s,n,a,o=this.options.range,r=this.options,h=this,l=this._animateOff?!1:r.animate,u={};this.options.values&&this.options.values.length?this.handles.each(function(s){
        ...
        var i,s,n,a,o=e(t.target).data('ui-slider-handle-index');switch(t.keyCode){
            case e.ui.keyCode.HOME:case e.ui.keyCode.END:case e.ui.keyCode.PAGE_UP:case e.ui.keyCode.PAGE_DOWN:case e.ui.keyCode.UP:case e.ui.keyCode.RIGHT:case e.ui.keyCode.DOWN:case e.ui.keyCode.LEFT:if(t.preventDefault(),!this._keySliding&&(this._keySliding=!0,e(t.target).addClass('ui-state-active'),i=this._start(t,o),i===!1)){
                return;
            }
        }switch(a=this.options.step,s=n=this.options.values&&this.options.values.length?this.values(o):this.value(),t.keyCode){
            case e.ui.keyCode.HOME:n=this._valueMin();break;case e.ui.keyCode.END:n=this._valueMax();break;case e.ui.keyCode.PAGE_UP:n=this._trimAlignValue(s+(this._valueMax()-this._valueMin())/this.numPages);break;case e.ui.keyCode.PAGE_DOWN:n=this._trimAlignValue(s-(this._valueMax()-this._valueMin())/this.numPages);break;case e.ui.keyCode.UP:case e.ui.keyCode.RIGHT:if(s===this._valueMax()){
                return;
            }n=this._trimAlignValue(s+a);break;case e.ui.keyCode.DOWN:case e.ui.keyCode.LEFT:if(s===this._valueMin()){
                return;
        ...
        var t={},i=this.element;return e.each(['min','max','step'],function(e,s){
        ...
        var i=this.options,s=e.ui.keyCode;switch(t.keyCode){
            case s.UP:return this._repeat(null,1,t),!0;case s.DOWN:return this._repeat(null,-1,t),!0;case s.PAGE_UP:return this._repeat(null,i.page,t),!0;case s.PAGE_DOWN:return this._repeat(null,-i.page,t),!0;
        }return!1;
        ...
        var t,i,s=this.options;return t=null!==s.min?s.min:0,i=e-t,i=Math.round(i/s.step)*s.step,e=t+i,e=parseFloat(e.toFixed(this._precision())),null!==s.max&&e>s.max?s.max:null!==s.min&&s.min>e?s.min:e;
    },_stop:function(e){
        ...
        var t=this.options.active,i=this.options.collapsible,s=location.hash.substring(1);return null===t&&(s&&this.tabs.each(function(i,n){
            return e(n).attr('aria-controls')===s?(t=i,!1):void 0;
        }),null===t&&(t=this.tabs.index(this.tabs.filter('.ui-tabs-active'))),(null===t||-1===t)&&(t=this.tabs.length?0:!1)),t!==!1&&(t=this.tabs.index(this.tabs.eq(t)),-1===t&&(t=i?!1:0)),!i&&t===!1&&this.anchors.length&&(t=0),t;
    },_getCreateEventData:function(){
        return{tab:this.active,panel:this.active.length?this._getPanelForTab(this.active):e()};
    },_tabKeydown:function(t){
        var i=e(this.document[0].activeElement).closest('li'),s=this.tabs.index(i),n=!0;if(!this._handlePageNav(t)){
            switch(t.keyCode){
                case e.ui.keyCode.RIGHT:case e.ui.keyCode.DOWN:s++;break;case e.ui.keyCode.UP:case e.ui.keyCode.LEFT:n=!1,s--;break;case e.ui.keyCode.END:s=this.anchors.length-1;break;case e.ui.keyCode.HOME:s=0;break;case e.ui.keyCode.SPACE:return t.preventDefault(),clearTimeout(this.activating),this._activate(s),void 0;case e.ui.keyCode.ENTER:return t.preventDefault(),clearTimeout(this.activating),this._activate(s===this.options.active?!1:s),void 0;default:return;
        ...
        var t=this.options,i=this.tablist.children(':has(a[href])');t.disabled=e.map(i.filter('.ui-state-disabled'),function(e){
            return i.index(e);
        ...
        var i,s=this.element.parent();'fill'===t?(i=s.height(),i-=this.element.outerHeight()-this.element.height(),this.element.siblings(':visible').each(function(){
            var t=e(this),s=t.css('position');'absolute'!==s&&'fixed'!==s&&(i-=t.outerHeight(!0));
        ...
        var i=this.options,s=this.active,n=e(t.currentTarget),a=n.closest('li'),o=a[0]===s[0],r=o&&i.collapsible,h=r?e():this._getPanelForTab(a),l=s.length?this._getPanelForTab(s):e(),u={oldTab:s,oldPanel:l,newTab:r?e():a,newPanel:h};t.preventDefault(),a.hasClass('ui-state-disabled')||a.hasClass('ui-tabs-loading')||this.running||o&&!i.collapsible||this._trigger('beforeActivate',t,u)===!1||(i.active=r?!1:this.tabs.index(a),this.active=o?e():a,this.xhr&&this.xhr.abort(),l.length||h.length||e.error('jQuery UI Tabs: Mismatching fragment identifier.'),h.length&&this.load(this.tabs.index(a),t),this._toggle(t,u));
        ...
        var i,s=this._findActive(t);s[0]!==this.active[0]&&(s.length||(s=this.active),i=s.find('.ui-tabs-anchor')[0],this._eventHandler({target:i,currentTarget:i,preventDefault:e.noop}));
    },_findActive:function(t){
        ...
        this.xhr&&this.xhr.abort(),this.element.removeClass('ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsible'),this.tablist.removeClass('ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all').removeAttr('role'),this.anchors.removeClass('ui-tabs-anchor').removeAttr('role').removeAttr('tabIndex').removeUniqueId(),this.tablist.unbind(this.eventNamespace),this.tabs.add(this.panels).each(function(){
            ...
            var t=e(this),i=t.data('ui-tabs-aria-controls');i?t.attr('aria-controls',i).removeData('ui-tabs-aria-controls'):t.removeAttr('aria-controls');
        ...
        t=this._getIndex(t);var s=this,n=this.tabs.eq(t),a=n.find('.ui-tabs-anchor'),o=this._getPanelForTab(n),r={tab:n,panel:o},h=function(e,t){
        ...
        var i=t.data('ui-tooltip-id'),s=(t.attr('aria-describedby')||'').split(/\s+/),n=e.inArray(i,s);-1!==n&&s.splice(n,1),t.removeData('ui-tooltip-id'),s=e.trim(s.join(' ')),s?t.attr('aria-describedby',s):t.removeAttr('aria-describedby');
    },_create:function(){
        ...
        var i=this,s=e(t?t.target:this.element).closest(this.options.items);s.length&&!s.data('ui-tooltip-id')&&(s.attr('title')&&s.data('ui-tooltip-title',s.attr('title')),s.data('ui-tooltip-open',!0),t&&'mouseover'===t.type&&s.parents().each(function(){
            var t,s=e(this);s.data('ui-tooltip-open')&&(t=e.Event('blur'),t.target=t.currentTarget=this,i.close(t,!0)),s.attr('title')&&(s.uniqueId(),i.parents[this.id]={element:this,title:s.attr('title')},s.attr('title',''));
        }),this._registerCloseHandlers(t,s),this._updateContent(s,t));
    },_updateContent:function(e,t){
        var i,s=this.options.content,n=this,a=t?t.type:null;return'string'==typeof s?this._open(t,e,s):(i=s.call(e[0],function(i){
            n._delay(function(){
        ...
        }var a,o,r,h,l=e.extend({},this.options.position);if(s){
            if(a=this._find(i)){
        ...
        var i,s=this,n=e(t?t.currentTarget:this.element),a=this._find(n);return a?(i=a.tooltip,a.closing||(clearInterval(this.delayedShow),n.data('ui-tooltip-title')&&!n.attr('title')&&n.attr('title',n.data('ui-tooltip-title')),this._removeDescribedBy(n),a.hiding=!0,i.stop(!0),this._hide(i,this.options.hide,function(){
        ...
        var i=e('<div>').attr('role','tooltip').addClass('ui-tooltip ui-widget ui-corner-all ui-widget-content '+(this.options.tooltipClass||'')),s=i.uniqueId().attr('id');return e('<div>').addClass('ui-tooltip-content').appendTo(i),i.appendTo(this.document[0].body),this.tooltips[s]={element:t,tooltip:i};
    },_find:function(e){
        ...
        var t=this;e.each(this.tooltips,function(i,s){
            var n=e.Event('blur'),a=s.element;n.target=n.currentTarget=a[0],t.close(n,!0),e('#'+i).remove(),a.data('ui-tooltip-title')&&(a.attr('title')||a.attr('title',a.data('ui-tooltip-title')),a.removeData('ui-tooltip-title'));
        }),this.liveRegion.remove();
    }});var y='ui-effects-',b=e;e.effects={effect:{}},function(e,t){
        function i(e,t,i){
            ...
            var s=l(),n=s._rgba=[];return i=i.toLowerCase(),f(h,function(e,a){
                var o,r=a.re.exec(i),h=r&&a.parse(r),l=a.space||'rgba';return h?(o=s[l](h),s[u[l].cache]=o[u[l].cache],n=s._rgba=o._rgba,!1):t;
            ...
            },u={rgba:{props:{red:{idx:0,type:'byte'},green:{idx:1,type:'byte'},blue:{idx:2,type:'byte'}}},hsla:{props:{hue:{idx:0,type:'degrees'},saturation:{idx:1,type:'percent'},lightness:{idx:2,type:'percent'}}}},d={'byte':{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},c=l.support={},p=e('<p>')[0],f=e.each;p.style.cssText='background-color:rgba(1,1,1,.5)',c.rgba=p.style.backgroundColor.indexOf('rgba')>-1,f(u,function(e,t){
            t.cache='_'+e,t.props.alpha={idx:3,type:'percent',def:1};
        }),l.fn=e.extend(l.prototype,{parse:function(n,o,r,h){
            if(n===t){
                return this._rgba=[null,null,null,null],this;
            }(n.jquery||n.nodeType)&&(n=e(n).css(o),o=t);var d=this,c=e.type(n),p=this._rgba=[];return o!==t&&(n=[n,o,r,h],c='array'),'string'===c?this.parse(s(n)||a._default):'array'===c?(f(u.rgba.props,function(e,t){
                p[t.idx]=i(n[t.idx],t);
            ...
            var i=l(e),s=!0,n=this;return f(u,function(e,a){
                var o,r=i[a.cache];return r&&(o=n[a.cache]||a.to&&a.to(n._rgba)||[],f(a.props,function(e,i){
            ...
            var s=l(e),n=s._space(),a=u[n],o=0===this.alpha()?l('transparent'):this,r=o[a.cache]||a.to(o._rgba),h=r.slice();return s=s[a.cache],f(a.props,function(e,n){
                var a=n.idx,o=r[a],l=s[a],u=d[n.type]||{};null!==l&&(null===o?h[a]=l:(u.mod&&(l-o>u.mod/2?o+=u.mod:o-l>u.mod/2&&(o-=u.mod)),h[a]=i((l-o)*t+o,n)));
            }),this[n](h);
        },blend:function(t){
            if(1===this._rgba[3]){
                return this;
            }var i=this._rgba.slice(),s=i.pop(),n=l(t)._rgba;return l(e.map(i,function(e,t){
                return(1-s)*n[t]+s*e;
            }));
            ...
            }var t,i,s=e[0]/255,n=e[1]/255,a=e[2]/255,o=e[3],r=Math.max(s,n,a),h=Math.min(s,n,a),l=r-h,u=r+h,d=.5*u;return t=h===r?0:s===r?60*(n-a)/l+360:n===r?60*(a-s)/l+120:60*(s-n)/l+240,i=0===l?0:.5>=d?l/u:l/(2-u),[Math.round(t)%360,i,d,null==o?1:o];
            ...
            var a=n.props,o=n.cache,h=n.to,u=n.from;l.fn[s]=function(s){
                if(h&&!this[o]&&(this[o]=h(this._rgba)),s===t){
                    return this[o].slice();
                }var n,r=e.type(s),d='array'===r||'object'===r?s:arguments,c=this[o].slice();return f(a,function(e,t){
                    var s=d['object'===r?e:t.idx];null==s&&(s=c[t.idx]),c[t.idx]=i(s,t);
                }),u?(n=l(u(c)),n[o]=c,n):l(c);
            },f(a,function(t,i){
                l.fn[t]||(l.fn[t]=function(n){
                    var a,o=e.type(n),h='alpha'===t?this._hsla?'hsla':'rgba':s,l=this[h](),u=l[i.idx];return'undefined'===o?u:('function'===o&&(n=n.call(this,u),o=e.type(n)),null==n&&i.empty?this:('string'===o&&(a=r.exec(n),a&&(n=u+parseFloat(a[2])*('+'===a[1]?1:-1))),l[i.idx]=n,this[h](l)));
                });
            });
        }),l.hook=function(t){
            var i=t.split(' ');f(i,function(t,i){
                e.cssHooks[i]={set:function(t,n){
                    var a,o,r='';if('transparent'!==n&&('string'!==e.type(n)||(a=s(n)))){
        ...
        function t(t){
            var i,s,n=t.ownerDocument.defaultView?t.ownerDocument.defaultView.getComputedStyle(t,null):t.currentStyle,a={};if(n&&n.length&&n[0]&&n[n[0]]){
                for(s=n.length;s--;){
            ...
            var s,a,o={};for(s in i){
                a=i[s],t[s]!==a&&(n[s]||(e.fx.step[s]||!isNaN(parseFloat(a)))&&(o[s]=a));
            }return o;
        }var s=['add','remove','toggle'],n={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};e.each(['borderLeftStyle','borderRightStyle','borderBottomStyle','borderTopStyle'],function(t,i){
            ...
            var h=e.speed(a,o,r);return this.queue(function(){
                var a,o=e(this),r=o.attr('class')||'',l=h.children?o.find('*').addBack():o;l=l.map(function(){
        ...
        function t(t,i,s,n){
            ...
            if(t.parent().is('.ui-effects-wrapper')){
                return t.parent();
            }var i={width:t.outerWidth(!0),height:t.outerHeight(!0),'float':t.css('float')},s=e('<div></div>').addClass('ui-effects-wrapper').css({fontSize:'100%',background:'transparent',border:'none',margin:0,padding:0}),n={width:t.width(),height:t.height()},a=document.activeElement;try{
                a.id;
            }catch(o){
                a=document.body;
            ...
            }var s=t.apply(this,arguments),n=s.mode,a=s.queue,o=e.effects.effect[s.effect];return e.fx.off||!o?n?this[n](s.duration,s.complete):this.each(function(){
            ...
            return function(s){
                ...
                }var n=t.apply(this,arguments);return n.mode='show',this.effect.call(this,n);
            };
            ...
            return function(s){
                if(i(s)||'boolean'==typeof s){
                    return e.apply(this,arguments);
                }var n=t.apply(this,arguments);return n.mode='toggle',this.effect.call(this,n);
            };
        ...
        var s,n,a,o=e(this),r=['position','top','bottom','left','right','height','width'],h=e.effects.setMode(o,t.mode||'hide'),l='show'===h,u=t.direction||'vertical',d='vertical'===u,c=d?'height':'width',p=d?'top':'left',f={};e.effects.save(o,r),o.show(),s=e.effects.createWrapper(o).css({overflow:'hidden'}),n='IMG'===o[0].tagName?s:o,a=n[c](),l&&(n.css(c,0),n.css(p,a/2)),f[c]=l?a:0,f[p]=l?0:a/2,n.animate(f,{queue:!1,duration:t.duration,easing:t.easing,complete:function(){
            l||o.hide(),e.effects.restore(o,r),e.effects.removeWrapper(o),i();
        }});
    },e.effects.effect.drop=function(t,i){
        var s,n=e(this),a=['position','top','bottom','left','right','opacity','height','width'],o=e.effects.setMode(n,t.mode||'hide'),r='show'===o,h=t.direction||'left',l='up'===h||'down'===h?'top':'left',u='up'===h||'left'===h?'pos':'neg',d={opacity:r?1:0};e.effects.save(n,a),n.show(),e.effects.createWrapper(n),s=t.distance||n['top'===l?'outerHeight':'outerWidth'](!0)/2,r&&n.css('opacity',0).css(l,'pos'===u?-s:s),d[l]=(r?'pos'===u?'+=':'-=':'pos'===u?'-=':'+=')+s,n.animate(d,{queue:!1,duration:t.duration,easing:t.easing,complete:function(){
        ...
        }var a,o,r,h,l,u,d=t.pieces?Math.round(Math.sqrt(t.pieces)):3,c=d,p=e(this),f=e.effects.setMode(p,t.mode||'hide'),m='show'===f,g=p.show().css('visibility','hidden').offset(),v=Math.ceil(p.outerWidth()/c),y=Math.ceil(p.outerHeight()/d),b=[];for(a=0;d>a;a++){
        ...
        var s=e(this),n=e.effects.setMode(s,t.mode||'toggle');s.animate({opacity:n},{queue:!1,duration:t.duration,easing:t.easing,complete:i});
        ...
        var s=e(this),n=['backgroundImage','backgroundColor','opacity'],a=e.effects.setMode(s,t.mode||'show'),o={backgroundColor:s.css('backgroundColor')};'hide'===a&&(o.opacity=0),e.effects.save(s,n),s.show().css({backgroundImage:'none',backgroundColor:t.color||'#ffff99'}).animate(o,{queue:!1,duration:t.duration,easing:t.easing,complete:function(){
        ...
        var s,n,a,o=e(this),r=['position','top','bottom','left','right','width','height','overflow','opacity'],h=['position','top','bottom','left','right','overflow','opacity'],l=['width','height','overflow'],u=['fontSize'],d=['borderTopWidth','borderBottomWidth','paddingTop','paddingBottom'],c=['borderLeftWidth','borderRightWidth','paddingLeft','paddingRight'],p=e.effects.setMode(o,t.mode||'effect'),f=t.restore||'effect'!==p,m=t.scale||'both',g=t.origin||['middle','center'],v=o.css('position'),y=f?r:h,b={height:0,width:0,outerHeight:0,outerWidth:0};'show'===p&&o.show(),s={height:o.height(),width:o.width(),outerHeight:o.outerHeight(),outerWidth:o.outerWidth()},'toggle'===t.mode&&'show'===p?(o.from=t.to||b,o.to=t.from||s):(o.from=t.from||('show'===p?b:s),o.to=t.to||('hide'===p?b:s)),a={from:{y:o.from.height/s.height,x:o.from.width/s.width},to:{y:o.to.height/s.height,x:o.to.width/s.width}},('box'===m||'both'===m)&&(a.from.y!==a.to.y&&(y=y.concat(d),o.from=e.effects.setTransition(o,d,a.from.y,o.from),o.to=e.effects.setTransition(o,d,a.to.y,o.to)),a.from.x!==a.to.x&&(y=y.concat(c),o.from=e.effects.setTransition(o,c,a.from.x,o.from),o.to=e.effects.setTransition(o,c,a.to.x,o.to))),('content'===m||'both'===m)&&a.from.y!==a.to.y&&(y=y.concat(u).concat(l),o.from=e.effects.setTransition(o,u,a.from.y,o.from),o.to=e.effects.setTransition(o,u,a.to.y,o.to)),e.effects.save(o,y),o.show(),e.effects.createWrapper(o),o.css('overflow','hidden').css(o.from),g&&(n=e.effects.getBaseline(g,s),o.from.top=(s.outerHeight-o.outerHeight())*n.y,o.from.left=(s.outerWidth-o.outerWidth())*n.x,o.to.top=(s.outerHeight-o.to.outerHeight)*n.y,o.to.left=(s.outerWidth-o.to.outerWidth)*n.x),o.css(o.from),('content'===m||'both'===m)&&(d=d.concat(['marginTop','marginBottom']).concat(u),c=c.concat(['marginLeft','marginRight']),l=r.concat(d).concat(c),o.find('*[width]').each(function(){
            var i=e(this),s={height:i.height(),width:i.width(),outerHeight:i.outerHeight(),outerWidth:i.outerWidth()};f&&e.effects.save(i,l),i.from={height:s.height*a.from.y,width:s.width*a.from.x,outerHeight:s.outerHeight*a.from.y,outerWidth:s.outerWidth*a.from.x},i.to={height:s.height*a.to.y,width:s.width*a.to.x,outerHeight:s.height*a.to.y,outerWidth:s.width*a.to.x},a.from.y!==a.to.y&&(i.from=e.effects.setTransition(i,d,a.from.y,i.from),i.to=e.effects.setTransition(i,d,a.to.y,i.to)),a.from.x!==a.to.x&&(i.from=e.effects.setTransition(i,c,a.from.x,i.from),i.to=e.effects.setTransition(i,c,a.to.x,i.to)),i.css(i.from),i.animate(i.to,t.duration,t.easing,function(){
        ...
        var s,n=e(this),a=e.effects.setMode(n,t.mode||'show'),o='show'===a,r='hide'===a,h=o||'hide'===a,l=2*(t.times||5)+(h?1:0),u=t.duration/l,d=0,c=n.queue(),p=c.length;for((o||!n.is(':visible'))&&(n.css('opacity',0).show(),d=1),s=1;l>s;s++){
            n.animate({opacity:d},u,t.easing),d=1-d;
        }n.animate({opacity:d},u,t.easing),n.queue(function(){
            r&&n.hide(),i();
        }),p>1&&c.splice.apply(c,[1,0].concat(c.splice(p,l+1))),n.dequeue();
    },e.effects.effect.shake=function(t,i){
        var s,n=e(this),a=['position','top','bottom','left','right','height','width'],o=e.effects.setMode(n,t.mode||'effect'),r=t.direction||'left',h=t.distance||20,l=t.times||3,u=2*l+1,d=Math.round(t.duration/u),c='up'===r||'down'===r?'top':'left',p='up'===r||'left'===r,f={},m={},g={},v=n.queue(),y=v.length;for(e.effects.save(n,a),n.show(),e.effects.createWrapper(n),f[c]=(p?'-=':'+=')+h,m[c]=(p?'+=':'-=')+2*h,g[c]=(p?'-=':'+=')+2*h,n.animate(f,d,t.easing),s=1;l>s;s++){
            n.animate(m,d,t.easing).animate(g,d,t.easing);
        }n.animate(m,d,t.easing).animate(f,d/2,t.easing).queue(function(){
            'hide'===o&&n.hide(),e.effects.restore(n,a),e.effects.removeWrapper(n),i();
        }),y>1&&v.splice.apply(v,[1,0].concat(v.splice(y,u+1))),n.dequeue();
    },e.effects.effect.slide=function(t,i){
        var s,n=e(this),a=['position','top','bottom','left','right','width','height'],o=e.effects.setMode(n,t.mode||'show'),r='show'===o,h=t.direction||'left',l='up'===h||'down'===h?'top':'left',u='up'===h||'left'===h,d={};e.effects.save(n,a),n.show(),s=t.distance||n['top'===l?'outerHeight':'outerWidth'](!0),e.effects.createWrapper(n).css({overflow:'hidden'}),r&&n.css(l,u?isNaN(s)?'-'+s:-s:s),d[l]=(r?u?'+=':'-=':u?'-=':'+=')+s,n.animate(d,{queue:!1,duration:t.duration,easing:t.easing,complete:function(){
            'hide'===o&&n.hide(),e.effects.restore(n,a),e.effects.removeWrapper(n),i();
        }});
