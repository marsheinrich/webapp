...
!function(factory) {
    ...
    function maskScope(actionObj, maskset, opts) {
        function getMaskTemplate(baseOnInput, minimalPos, includeMode) {
            ...
            do {
                baseOnInput === !0 && getMaskSet().validPositions[pos] ? (testPos = getMaskSet().validPositions[pos], 
        ...
        function stripValidPositions(start, end, nocheck, strict) {
            ...
            for (getMaskSet().p = start, i = end - 1; i >= startPos; i--) {
                getMaskSet().validPositions[i] !== undefined && (nocheck !== !0 && (!getMaskSet().validPositions[i].match.optionality && IsEnclosedStatic(i) || opts.canClearPosition(getMaskSet(), i, getLastValidPosition(), strict, opts) === !1) || delete getMaskSet().validPositions[i]);
            }
                ...
                function handleMatch(match, loopNdx, quantifierRecurse) {
                    function isFirstMatch(latestMatch, tokenGroup) {
                        ...
                        return firstMatch || $.each(tokenGroup.matches, function(ndx, match) {
                            if (match.isQuantifier === !0 && (firstMatch = isFirstMatch(latestMatch, tokenGroup.matches[ndx - 1]))) {
                                return !1;
                            }
                        }), firstMatch;
                    }
        ...
        function checkAlternationMatch(altArr1, altArr2, na) {
            for (var naNdx, altArrC = opts.greedy ? altArr2 : altArr2.slice(0, 1), isMatch = !1, naArr = na !== undefined ? na.split(',') : [], i = 0; i < naArr.length; i++) {
                (naNdx = altArr1.indexOf(naArr[i])) !== -1 && altArr1.splice(naNdx, 1);
            }
        ...
        function isValid(pos, c, strict, fromSetValid, fromAlternate) {
                ...
                return $.each(getTests(position), function(ndx, tst) {
                    ...
                    if (c && (chrs += c), getBuffer(!0), rslt = null != test.fn ? test.fn.test(chrs, getMaskSet(), position, strict, opts, isSelection(pos)) : (c === test.def || c === opts.skipOptionalPartCharacter) && '' !== test.def && {
                        ...
                        $.each(rslt.insert.sort(function(a, b) {
                            ...
                            if (validatedPos = rslt.pos !== undefined ? rslt.pos : position, validatedPos !== position) {
                        ...
                        if (t !== undefined) {
                            for (var posMatch = j; posMatch < getMaskSet().maskLength && (null === t.match.fn && vps[i] && (vps[i].match.optionalQuantifier === !0 || vps[i].match.optionality === !0) || null != t.match.fn); ) {
                                if (posMatch++, needsValidation === !1 && positionsClone[posMatch] && positionsClone[posMatch].match.def === t.match.def) {
                                    ...
                                    needsValidation = !0;
                                } else if (valid = t.generatedInput === !0, !valid && posMatch >= getMaskSet().maskLength - 1) {
                                    break;
                                }
            ...
            function fillMissingNonMask(maskPos) {
                ...
                for (pndx++; pndx < maskPos; pndx++) {
                    getMaskSet().validPositions[pndx] === undefined && (opts.jitMasking === !1 || opts.jitMasking > pndx) && (testsFromPos = getTests(pndx, getTestTemplate(pndx - 1).locator, pndx - 1).slice(), 
        ...
        function getPlaceholder(pos, test, returnPL) {
            if (test = test || getTest(pos).match, test.placeholder !== undefined || returnPL === !0) {
                ...
                if (pos > -1 && getMaskSet().validPositions[pos] === undefined) {
                    ...
                    if (tests.length > 1 + ('' === tests[tests.length - 1].match.def ? 1 : 0)) {
                        for (var i = 0; i < tests.length; i++) {
                            if (tests[i].match.optionality !== !0 && tests[i].match.optionalQuantifier !== !0 && (null === tests[i].match.fn || prevTest === undefined || tests[i].match.fn.test(prevTest.match.def, getMaskSet(), pos, !0, opts) !== !1) && (staticAlternations.push(tests[i]), 
        ...
        function clearOptionalTail(buffer) {
            for (var validPos, rl = determineLastRequiredPosition(), bl = buffer.length; rl < bl && !isMask(rl + 1) && (validPos = getTest(rl + 1)) && validPos.match.optionality !== !0 && validPos.match.optionalQuantifier !== !0; ) {
                rl++;
            }
            for (;(validPos = getTest(rl - 1)) && validPos.match.optionality && validPos.input === opts.skipOptionalPartCharacter; ) {
                rl--;
            }
                ...
                inputFallBackEvent: function(e) {
                    ...
                    if (getBuffer().join('') !== inputValue) {
                        ...
                        getBuffer().length - inputValue.length !== 1 || inputValue.charAt(caretPos.begin) === getBuffer()[caretPos.begin] || inputValue.charAt(caretPos.begin + 1) === getBuffer()[caretPos.begin] || isMask(caretPos.begin)) {
                            ...
                            if (0 === currentValue.indexOf(stickyParts[0]) && currentPos !== stickyParts[0].length) {
                                ...
                                switch (opts.positionCaretOnClick) {
                                    ...
                                    default:
                                        ...
                                        if (clickPosition < lastPosition) {
                                            caret(input, isMask(clickPosition) || isMask(clickPosition - 1) ? clickPosition : seekNext(clickPosition));
                                        } else {
        ...
        numeric: {
            ...
            preValidation: function(buffer, pos, c, isSelection, opts) {
                if ('-' === c || c == opts.negationSymbol.front) {
                    return opts.allowMinus === !0 && (opts.isNegative = opts.isNegative === undefined || !opts.isNegative, 
                    '' === buffer.join('') || {
                        caret: pos,
                        dopost: !0
                    });
                ...
                if (isSelection === !1 && c === opts.radixPoint && opts.digits !== undefined && (isNaN(opts.digits) || parseInt(opts.digits) > 0)) {
                    ...
                    if (radixPos !== -1) {
                        return opts.numericInput === !0 ? pos === radixPos : {
                            caret: radixPos + 1
                        };
                    }
                }
            ...
            postValidation: function(buffer, currentResult, opts) {
                ...
                if (currentResult.pos == undefined && currentResult.caret !== undefined && currentResult.dopost !== !0) {
                ...
                '' !== processValue) {
                    if (processValue = processValue.split(''), !opts.digitsOptional && isFinite(opts.digits)) {
                        ...
                        for (var i = 1; i <= opts.digits; i++) {
                            opts.digitsOptional || processValue[radixPosition + i] !== undefined && processValue[radixPosition + i] !== opts.placeholder.charAt(0) ? rpb !== -1 && maskedValue[rpb + i] !== undefined && (processValue[radixPosition + i] = processValue[radixPosition + i] || maskedValue[rpb + i]) : processValue[radixPosition + i] = currentResult.placeholder || opts.placeholder.charAt(0);
                        }
                    }
