...
import { EzEmployeeDashboardView } from '/secure/javascript/employeeDashboard/employeeDashboard-DisplayEmployeeInfo.js';
...
export class EzEmployeeDashboardController extends EzClass {
    ...
    static #ezInstance = EzObject.hasProperty(globalThis, 'ezApi') &&
        ...
        EzObject.isValid(globalThis.ezApi.ezclocker[EzEmployeeDashboardController.ezApiName])
    ...
    get ezDisallowWebTimeEntry() {
        let disallowWebTimeEntry = ezApi.ezclocker.ezClockerContext.ezGetSelectedEmployeePermission(
            EzUserPermissionType.DISALLOW_EMPLOYEE_WEB_TIMEENTRY);

        return EzObject.isValid(disallowWebTimeEntry) && EzBoolean.isTrue(disallowWebTimeEntry.enabled);
    }
    ...
    get ezDisallowWebAddTimeEntry() {
        let disallowWebAddTimeEntry = ezApi.ezclocker.ezClockerContext.ezGetSelectedEmployeePermission(
            EzUserPermissionType.DISALLOW_WEB_ADD_TIMEENTRY);

        return EzObject.isValid(disallowWebAddTimeEntry) && EzBoolean.isTrue(disallowWebAddTimeEntry.enabled);
    }
    ...
    /**
        ...
        A valid enumeration property value from EzEmployeeDashboardMode
     */
    set ezEmployeeDashboardMode(ezEmployeeDashboardMode) {
        this.#ezEmployeeDashboardMode = EzEmployeeDashboardMode.ezAsEnum(ezEmployeeDashboardMode);
    }
    ...
    get ezAllowUnpaidBreaks() {
        return ezApi.ezclocker.ezBreakInBreakOutHelper.ezAllowRecordingBreaks =
            ezApi.ezclocker.ezOptionsService.ezOptionValueToBoolean(
                ezApi.ezclocker.ezClockerContext.ezReadActiveEmployerOption(
    ...
    /**
        ...
        @returns {object}
     */
    set ezReadyFlags(ezReadyFlags) {
        if (!EzObject.isValid(ezReadyFlags)) {
        ...
        this.ezReadyFlags = ezReadyFlags;
    }
     ...
     */
    ezProcessReadyFlags() {
        return EzEmployeeDashboardController.ezInstance.ezProcessDashboardReadyFlags()
            .then(EzEmployeeDashboardController.ezInstance.ezProcessEmployeeDashboardReadyFlags)
                ...
                (timeEntryAssignedDataTagMaps) => ezApi.ezclocker.ezUi.ezStartPageWaitResolve(
                    ...
                    (waitDone, resolve) => {
                        ezApi.ezclocker.ezClockInClockOutHelper.ezClockIn(
                            ...
                            .then((response) => waitDone().then(() => resolve(response)),
